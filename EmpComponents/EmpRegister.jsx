              ...
              <View style={styles.selectedRole}>
                ...
                <View style={styles.buttonContainer}>
                  <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate('AqmSignup')}>
                    <Text style={{fontWeight: 'bold', color: '#3F9E7E'}}>
                      AQM
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.buttons}>
                    <Text
                      style={{fontWeight: 'bold', color: '#3F9E7E'}}
                      onPress={() => navigation.navigate('TlSignup')}>
                      Team Manager
                    </Text>
                  </TouchableOpacity>
                </View>
                <View style={styles.buttonContainer}>
                  <TouchableOpacity style={styles.buttons2}>
                    <Text
                      ...
                      onPress={() => navigation.navigate('HrSignup')}>
                      HR
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.buttons2}>
